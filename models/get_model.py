...
def get_model(args, tasks_outputs, num_inp_feats=3, pretrained=True):
    # NOTE: new_out_size is for resizing outputs
    ...
    sr_type = args.sr_type if "sr_type" in args.__dict__ else "model"
    ...
    model = MultiTaskModel(backbone, heads, args.tasks, sr_type=sr_type, new_out_size=args.resize_size)
